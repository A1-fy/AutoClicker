...
#       temporary focusing, current directions.
#
...
#
# Only set APPEND_JAVA_OPTS if the user hasn't set it to empty value
if [ -z "${APPEND_JAVA_OPTS:-}" ] ; then
    APPEND_JAVA_OPTS=true
fi

if [ "$APPEND_JAVA_OPTS" = "true" ] ; then
    GRADLE_OPTS="$( eval echo "$GRADLE_OPTS" )"
    DEFAULT_JVM_OPTS="$( eval echo "$DEFAULT_JVM_OPTS" )"
    APPEND_JAVA_OPTS=false
fi

# Collect all arguments for the java command;
#   * $DEFAULT_JVM_OPTS, $JAVA_OPTS, and $GRADLE_OPTS can contain fragments of
#     shell script including quotes and variable substitutions, so put them in
#     temporary variables and expand them as part of executing the java command.
